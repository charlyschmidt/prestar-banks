...
@section('content')
    ...
    ========================================================== --}}
        ...
        <div class="account-movements-header">
            ...
            <div class="account-movements-header-actions">
                ...
                <a href="{{ route('accounts.movement-control', $account->id) }}" class="primary-action-button m-2">
    ...
    ========================================================== --}}
        ...
        <div class="account-balance-summary">
            ...
            @forelse ($balances as $balance)
                ...
                <div class="account-balance-card" data-account-balance-id="{{ $balance->account_balance_id }}">
                    ...
                    <tbody>
                        ...
                        @forelse ($movements as $movement)
                            @php
                                ...
                                $canManage = auth()->user()->isSuperAdmin() || $movement->user_id === auth()->id();
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const form = document.getElementById('movement-control-form');
            const submitButton = document.getElementById('movement-control-submit');
